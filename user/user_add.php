...
if (isset($_POST['registrasi'])) {
    ...
    // simpan user baru
    $exec = mysqli_query($con, "INSERT INTO user(username,level,password) VALUES('$username','$level','$passHash')");
    if ($exec === true) {
    ...
    <div class="card-body">
        <form action="" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="passwordx" name="password" class="form-control" placeholder="Password" required>
                </div>
            </div>
            <div class="form-group row">
